...
MAIN	:= vga_music_v2.c
HDRS	:= treble_clef_bitmap.h background.h sequencer_audio.h sprites.h toolbar.h start_menu.h mic_input.h
SRCS	:= vga_music_v2.c background.c sequencer_audio.c toolbar.cstart_menu.c mic_input.c
