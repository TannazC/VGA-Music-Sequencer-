...
MAIN	:= main.c
HDRS	:= treble_clef_bitmap.h background.h sequencer_audio.h sprites.h toolbar.h piano_samples.h start_menu.h skinny_font.h xylophone_samples.h 
SRCS	:= main.c background.c sequencer_audio.c toolbar.c start_menu.c 
